...
<meta property="og:url" content="https://gojs.net/latest/intro/groups.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/groups.html" />
...
<p>
  ...
  This is distinct from collapsing and expanding trees.
</p>
...
<p>
  ...
  they are not in the visual tree of the group -- their <a>GraphObject.panel</a> is null and
  no member part is in the group's <a>Panel.elements</a> collection.
...
<p>
  ...
  You can declare that a node data be a member of a group by referring to the group's key as the group data property value.
</p>
<p>
...
<p>
  ...
  in order to demonstrate the default templates for Nodes, Groups, and Links.
</p>
...
<p>
  ...
  This is discussed in the next page about <a href="subgraphs.html">SubGraphs</a>.
</p>
