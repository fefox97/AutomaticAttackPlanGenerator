...
<meta itemprop="name" content="Server-Side Images" />
<meta property="og:title" content="Server-Side Images" />
<meta name="twitter:title" content="Server-Side Images" />
...
<meta property="og:url" content="https://gojs.net/latest/intro/serverSideImages.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/serverSideImages.html" />
...
<p>It may be useful for many applications to create images of Diagrams with <b>GoJS</b>, and this page details some of the options for such a task.</p>
<h2 id="Puppeteer">Puppeteer</h2>
<p>
  <a href="https://github.com/GoogleChrome/puppeteer">Puppeteer</a> is a Node library which provides a high-level API to control headless Chrome. We can use it
  to create images server-side. If you have Node and npm installed you can install it with <code>npm install puppeteer</code>.
</p>

<p>
  The following code is a small example using Puppeteer. If you saved the JavaScript as <code>puppet.js</code> and run it with node (<code
    >node createImage.js</code
  >) it demonstrate creating two images: One from the Diagram called <code>gojs-screenshot.png</code> and one of the HTML page called
  <code>page-screenshot.png</code>. The Diagram code in the sample is the same as that in the <a href="../samples/minimal.html">Minimal sample</a>.
</p>
...
(async () => {
  ...
  await page.addScriptTag({
    url: 'https://cdn.jsdelivr.net/npm/gojs'
    // path: '../../release/go.js'
  });
...
<p>You can also use Puppeteer to fetch live HTML pages and do the same operations:</p>
