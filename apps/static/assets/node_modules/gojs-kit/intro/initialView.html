...
<meta property="og:url" content="https://gojs.net/latest/intro/initialView.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/initialView.html" />
...
<pre class="lang-js" id="centernode"><code>
  ...
  diagram.addDiagramListener("InitialLayoutCompleted", e => {
    ...
    const data = nodeDataArray[Math.floor(Math.random()*nodeDataArray.length)];
