...
<meta property="og:url" content="https://gojs.net/latest/intro/nodes.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/nodes.html" />
...
<p>
  One way to implement this is to use a Spot <a>Panel</a>, where the main element is itself a Panel containing the
  elements that you always want to display, and there are additional objects located at spots around the main element.
...
<p>
  ...
  If you set the <a>GraphObject.position</a> of a Node, you will be modifying the <code>x</code> and <code>y</code> values
  of the node's <a>GraphObject.actualBounds</a>.
</p>
<p>
...
<p>
  ...
  In fact the default value for a node's position or location is <code>NaN, NaN</code> and it is the responsibility
  of either the <a>Diagram.layout</a> or data bindings to assign real point values for each node.
</p>
</div>
