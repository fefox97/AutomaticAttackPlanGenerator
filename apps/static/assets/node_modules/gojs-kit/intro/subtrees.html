...
<meta itemprop="name" content="SubTrees" />
<meta property="og:title" content="SubTrees" />
<meta name="twitter:title" content="SubTrees" />
...
<meta property="og:url" content="https://gojs.net/latest/intro/subtrees.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/subtrees.html" />
...
<p>
  To collapse a node in a tree, set <a>Node.isTreeExpanded</a> to false; to make sure it is expanded, set that property to true.
...
<p>
  Clicking on an expander button also invalidates the layout that is responsible for the node.
  Collapsing a subtree often results in a large empty area, and expanding a subtree often results in overlapping nodes,
...
<p>
  ...
  This is because the collapsing operation remembers the state of nodes within the subtree, as the property <a>Node.wasTreeExpanded</a>.
...
<p>
  ...
  Second, if you want to show some levels of the tree, call <a>Node.expandTree</a> on each root node.
</p>
