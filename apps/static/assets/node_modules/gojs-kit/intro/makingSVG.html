...
<p>
  As of version 2.3.11, <a>Diagram.makeSVG</a> and the <a href="SVGContext.html">SVG Rendering Context</a> both set some
  <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/data-*">SVG data attributes</a>
  on some of the SVG DOM elements.
  These are:
</p>
...
<p>So a Node with Node data with <code>{ key: 'Alpha' }</code> would have data properties:</p>
...
<p>
  If your app is served with a Content Security Policy, you may need to enable the dynamic rendering of SVG DOM.
  Read more at <a href="SVGContext.html#ContentSecurityPolicy">SVG Drawing Context</a>.
</p>
      </div>
    </div>
