...
<meta itemprop="name" content="Resizing Diagrams" />
<meta property="og:title" content="Resizing Diagrams" />
<meta name="twitter:title" content="Resizing Diagrams" />
...
<meta property="og:url" content="https://gojs.net/latest/intro/resizing.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/resizing.html" />
...
<p>
  Sometimes it may be necessary to resize the div that contains a GoJS Diagram. In older browsers or in Internet Explorer, GoJS does not listen or attempt to
  detect changes in the div's size, so you must manually tell each Diagram when you perform an action that resizes its containing div.
</p>

<h2 id="UsingRequestUpdateToResizeDiv">Using <a>Diagram.requestUpdate</a> to resize a Div</h2>
<p>
  The following example has a button that enlarges the Diagram's div. When it is clicked, the div is visibly resized but in older browsers the Diagram remains
  the same size.
</p>
...
<script>
  goCode('first', 100, 110, 'dia1');
</script>

<p>
  Typically we will want the Diagram to resize to its div at the same time that the div resizes. To do this we add a call to <a>Diagram.requestUpdate</a>
  <em>after</em> we have resized the div. This checks to see if the Diagram's div has changed size, and if so, redraws the diagram at the appropriate new
  dimensions.
</p>
<p>Below is nearly identical code, except that a call to <a>Diagram.requestUpdate</a> has been added.</p>
...
<script>
  goCode('second', 100, 110, 'dia2');
</script>

<p>
  In recent browsers the calls to <a>Diagram.requestUpdate</a> will not be necessary, but they will not cause any harm. Still, if you know that all of your
  users will be using recent browsers and if you are using GoJS version 2.1.26 or later, you do not need to make this call.
</p>
