...
<meta itemprop="name" content="Diagrams in Svelte with GoJS" />
<meta property="og:title" content="Diagrams in Svelte with GoJS" />
<meta name="twitter:title" content="Diagrams in Svelte with GoJS" />
...
<meta property="og:url" content="https://gojs.net/latest/intro/svelte.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/svelte.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Diagrams in Svelte with GoJS | GoJS
    </title>
...
<h1>Diagrams in Svelte with GoJS</h1>

<p>If you are new to GoJS, it may be helpful to first visit the <a href="../learn/index.html" target="_blank">Getting Started Tutorial</a>.</p>

<p>We maintain SvelteKit apps that use GoJS to demonstrate Diagramming in Svelte, they can be found <a href="../samples/#svelte">here</a>.</p>

<p>Svelte requires almost no special considerations for use with GoJS. In your project, install GoJS via npm or yarn:</p>

<code>npm i gojs</code>

<p>
  And you can use it in a Svelte app. GoJS Diagrams require a DIV, so you should initialize them within <code>onMount</code> to ensure the DOM is ready. An
  example:
</p>
...
<pre class="lang-html"><code>
  ...
  &lt;div id="myDiagramID" style="width: 500px; height: 500px;" &gt;&lt;/div&gt;
</code></pre>

<p>Svelte discourages referencing DOM <code>Id</code>s, so you can also reference the DIV directly with Svelte's <code>bind:this</code> attribute:</p>
...
<pre class="lang-html"><code>
  ...
  &lt;div bind:this={diagramDiv}  style="width: 500px; height: 500px;" &gt;&lt;/div&gt;
</code></pre>
