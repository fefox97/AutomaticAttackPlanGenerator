...
<meta itemprop="name" content="Building GoJS from Source" />
<meta property="og:title" content="Building GoJS from Source" />
<meta name="twitter:title" content="Building GoJS from Source" />
...
<meta property="og:url" content="https://gojs.net/latest/intro/source.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/source.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Building GoJS from Source | GoJS
    </title>
...
<p>
  All customers can use the <code>go.js</code> and <code>go-debug.js</code> files or the corresponding ES module files to run their app. However, if you have
  purchased a license to the <b>GoJS</b> TypeScript source code, you can build your app from the TypeScript source. Popular module bundlers such as Webpack are
...
<p>
  Because the <code>go.js</code> and <code>go-debug.js</code> files are built in a custom process to reduce size, using Webpack or another bundler with the GoJS
  source, even though it removes unused modules, may result in a larger file size than just using <code>go.js</code>. However, programmers using TypeScript may
...
<p>
  Several classes, such as <code>CommandHandler</code> and the Tools, may be essential to add to your project, while others such as all or all but one
  <code>Layout</code> and one type of <code>Model</code> can often be removed. Below is a list of modules that webpack can remove from builds, provided they are
  not referenced in your code:
</p>

<ul>
  <li><a>CommandHandler</a>, used for keyboard functionality.</li>
  <li><code>SVGSurface</code>, used by <a>Diagram.makeSvg</a>.</li>
  <li><a>GraphLinksModel</a>, without loading this module, the default Diagram.model is of type <code>Model</code>.</li>
  <li><a>TreeModel</a></li>
  <li><a>Overview</a>, for showing a thumbnail image of the whole document.</li>
  <li><a>Palette</a></li>
</ul>
...
Mouse-down tools:
<ul>
  <li><a>ActionTool</a></li>
  <li><a>RelinkingTool</a></li>
  <li><a>LinkReshapingTool</a></li>
  <li><a>ResizingTool</a></li>
  <li><a>RotatingTool</a></li>
</ul>

Mouse-move tools:
<ul>
  <li><a>LinkingTool</a></li>
  <li><a>DraggingTool</a></li>
  <li><a>DragSelectingTool</a></li>
  <li><a>PanningTool</a></li>
</ul>

Mouse-up tools:
<ul>
  <li><a>ContextMenuTool</a></li>
  <li><a>TextEditingTool</a></li>
  <li><a>ClickCreatingTool</a></li>
  <li><a>ClickSelectingTool</a></li>
</ul>
...
<ul>
  <li><code>PanelLayoutPosition</code></li>
  <li><code>PanelLayoutVertical</code></li>
  <li><code>PanelLayoutLink</code></li>
  <li><code>PanelLayoutAuto</code></li>
  <li><code>PanelLayoutGrid</code></li>
</ul>

However, it is possible to build without the following panel types:
<ul>
  <li><code>PanelLayoutHorizontal</code></li>
  <li><code>PanelLayoutSpot</code></li>
  <li><code>PanelLayoutTable</code></li>
  <li><code>PanelLayoutViewbox</code></li>
  <li><code>PanelLayoutTableRow</code></li>
  <li><code>PanelLayoutTableColumn</code></li>
  <li><code>PanelLayoutGraduated</code></li>
</ul>
...
<p>
  The GoJS source code is subject to the terms of our license, contained in
  <a href="https://nwoods.com/sales/info/SoftwareLicenseAgreement.pdf">SoftwareLicenseAgreement.pdf</a>.
</p>
<p>
