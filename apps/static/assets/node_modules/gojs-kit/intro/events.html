...
<meta property="og:url" content="https://gojs.net/latest/intro/events.html" />
<meta property="twitter:url" content="https://gojs.net/latest/intro/events.html" />
...
You can also register a diagram event handler in <a>Diagram</a> initialization options
when calling the <a>Diagram</a> constructor.
...
<p>
An InputEvent keeps the <a>InputEvent.key</a> and <a>InputEvent.code</a> for keyboard events,
...
<a>InputEvent.commandKey</a> is a read-only property that is convenient for use in overrides of
<a>CommandHandler.doKeyDown</a> or <a>Tool.doKeyDown</a>, instead of looking at both <a>InputEvent.key</a> and <a>InputEvent.code</a>
in order to decide how to handle the keyboard event.
