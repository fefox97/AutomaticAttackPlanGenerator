...
<meta name="description" content="A demonstration of the LassoSelectingTool extension." />
<meta itemprop="description" content="A demonstration of the LassoSelectingTool extension." />
<meta property="og:description" content="A demonstration of the LassoSelectingTool extension." />
<meta name="twitter:description" content="A demonstration of the LassoSelectingTool extension." />
...
<meta itemprop="name" content="LassoSelectingTool lets the user draw a lasso to select nodes" />
<meta property="og:title" content="LassoSelectingTool lets the user draw a lasso to select nodes" />
<meta name="twitter:title" content="LassoSelectingTool lets the user draw a lasso to select nodes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/lassoselecting.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/lassoselecting.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/lassoselecting.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/LassoSelecting.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/LassoSelecting.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      LassoSelectingTool lets the user draw a lasso to select nodes | GoJS Diagramming Library
    </title>
  </head>
...
<body>
  ...
  <script src="../extensions/LassoSelectingTool.js"></script>
  <script id="code">
    function init() {
      myDiagram =
      ...
      myDiagram.nodeTemplate =
        new go.Node("Auto")
          .add(
            new go.Shape({ fill: "white", portId: "" })
              .bind("fill", "color"),
      ...
      myDiagram.model = new go.GraphLinksModel(
        [
          ...
          { key: 7, text: "Eta", color: "goldenrod" },
          { key: 8, text: "Theta", color: "turquoise" }
        ],
        [
          { from: 1, to: 2 },
          { from: 1, to: 3 },
...
<div id="sample">
  ...
  <p>
    The <a>DragSelectingTool</a> has been replaced by the <a>LassoSelectingTool</a>.
    Mouse-down, wait 175 milliseconds, and drag the mouse around all nodes that you want to select.
    To be selected, a Node's <a>Node.selectionObject</a> must be completely within the temporarily-drawn magenta polygon.
    You can use the <code>Shift</code> and <code>Ctrl</code> modifiers to affect how the selection is affected.
  </p>
  <p>
    The tool is defined in its own file, as
    <a href="../extensions/LassoSelectingingTool.js">LassoSelectingTool.js</a>.
  </p>
</div>
