...
<meta itemprop="description" content="GoJS nodes containing simple bar charts." />
<meta property="og:description" content="GoJS nodes containing simple bar charts." />
<meta name="twitter:description" content="GoJS nodes containing simple bar charts." />
...
<meta itemprop="name" content="Bar Charts in Nodes" />
<meta property="og:title" content="Bar Charts in Nodes" />
<meta name="twitter:title" content="Bar Charts in Nodes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/barcharts.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/barcharts.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/barcharts.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/barCharts.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/barCharts.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Bar Charts in Nodes | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    const linkDataArray = [{ from: 1, to: 2 }];
...
<div id="sample">
  ...
  <p>
    Each node contains a Table Panel whose <a>Panel.itemArray</a> is data bound to the "items"
    property which holds an Array of data objects. That Table Panel has an
    <a>Panel.itemTemplate</a> which creates a bar (a rectangular Shape) and a TextBlock label for
    each item. Each bar also has a tooltip showing the value.
  </p>
  <p>
