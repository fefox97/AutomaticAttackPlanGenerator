...
<meta itemprop="description" content="Oil and gas production diagram editor, for designers." />
<meta property="og:description" content="Oil and gas production diagram editor, for designers." />
<meta name="twitter:description" content="Oil and gas production diagram editor, for designers." />
...
<meta itemprop="name" content="Production Process Diagram Editor" />
<meta property="og:title" content="Production Process Diagram Editor" />
<meta name="twitter:title" content="Production Process Diagram Editor" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/productioneditor.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/productioneditor.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/productioneditor.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/productionEditor.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/productionEditor.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Production Process Diagram Editor | GoJS Diagramming Library
    </title>
  </head>
      ...
      new go.Link({
        ...
        .add(
          ...
          new go.Shape({ isPanelMain: true, stroke: 'gray', strokeWidth: 10 })
            ...
            .bindObject('stroke', 'fromNode',
              n => go.Brush.lighten((n && Colors[n.data.color]) || 'gray'))
...
<div id="sample">
  <div style="width: 100%">
    <div style="width: 70%; display: inline-block">
      <div
        id="myPaletteDiv"
        style="border: solid 1px black; width: 100%; height: 100px; background: whitesmoke"></div>
      <div
        id="myDiagramDiv"
        style="border: solid 1px black; width: 100%; height: 550px; vertical-align: top"></div>
    </div>
    <div style="display: inline-block; vertical-align: top; width: 256px">
      <div id="infobox" style="background: #757575; color: #fff; padding: 20px">
  ...
  <div>
    <p>
      This process flow editor lets the user design diagrams to be shown by
      <a href="productionProcess.html">Production Process</a>.
    </p>
    <p>
      At the top is a <a>Palette</a>, from which the designer can drag-and-drop nodes down into the
      main <a>Diagram</a>. When the end-user selects a Node, more information is shown in the gray
      area below the diagram. For the designer, the <a>Inspector</a> also shows details about a
      selected Node or Link below the diagram, where the designer may modify some of the properties.
    </p>
    <p>
      Each <a>Node</a> consists of an SVG <a>Shape</a> at the top and a rectangular port at the
      bottom. The designer can draw new pipes (<a>Link</a>s) by dragging from a port to a different
      node's port.
    </p>
    <p>Below is the JSON data for the model:</p>
    <pre class="lang-js" style="max-height: 400px"><code id="mySavedModel">
