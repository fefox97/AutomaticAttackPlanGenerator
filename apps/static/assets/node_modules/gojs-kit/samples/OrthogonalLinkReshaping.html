...
<meta itemprop="description" content="An elaboration of the standard LinkReshapingTool that adds a broad handle to allow the user to easily drag a segment." />
<meta property="og:description" content="An elaboration of the standard LinkReshapingTool that adds a broad handle to allow the user to easily drag a segment." />
<meta name="twitter:description" content="An elaboration of the standard LinkReshapingTool that adds a broad handle to allow the user to easily drag a segment." />
...
<meta itemprop="name" content="Reshaping of Orthogonal Links and Adding/Removing Segments" />
<meta property="og:title" content="Reshaping of Orthogonal Links and Adding/Removing Segments" />
<meta name="twitter:title" content="Reshaping of Orthogonal Links and Adding/Removing Segments" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/orthogonallinkreshaping.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/orthogonallinkreshaping.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/orthogonallinkreshaping.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/OrthogonalLinkReshaping.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/OrthogonalLinkReshaping.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Reshaping of Orthogonal Links and Adding/Removing Segments | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    myDiagram.model = new go.GraphLinksModel({
      ...
      [
        ...
        { key: 2, text: 'Beta', location: '200 0' },
        { key: 3, text: 'Gamma', location: '100 0' }
      ],
  ...
  function updateRouting() {
    ...
    var newRouting = routing === 'orthogonal' ? go.Routing.Orthogonal : go.Routing.AvoidsNodes;
...
<div id="sample">
  ...
  Routing:
  <input type="radio" name="routing" id="option1" onclick="updateRouting()" value="orthogonal" />
  <label for="option1">Orthogonal</label>
  <input type="radio" name="routing" id="option2" onclick="updateRouting()" value="avoidsnodes" checked="checked" />
  <label for="option2">AvoidsNodes</label>
  <p style="margin-top: 1rem;">
    This sample demonstrates the OrthogonalLinkReshapingTool that is defined in its own file, as
    <a href="../extensions/OrthogonalLinkReshapingTool.js">OrthogonalLinkReshapingTool.js</a>. This tool allow users to shift the sections of orthogonal links in addition to
    resegmenting them. The Diagram's <a>ToolManager.linkReshapingTool</a> and link template's <a>Part.reshapable</a> properties must be set to use this tool.
