...
<script id="code">
  function init() {
    ...
    myDiagram.nodeTemplateMap.add('DistillationColumn',
      new go.Node('Spot', {
    ...
    myDiagram.nodeTemplateMap.add('Tank',
      new go.Node('Spot', {
          selectionObjectName: 'CAPSULE',
          resizable: true,
          resizeObjectName: 'CAPSULE',
    ...
    myDiagram.nodeTemplateMap.add('Condenser',
      new go.Node('Vertical')
        .bindTwoWay('location', 'pos', go.Point.parse, go.Point.stringify)
        .add(
          new go.Panel('Spot')
    ...
    myDiagram.nodeTemplateMap.add('Boiler',
      new go.Node('Vertical')
        .bindTwoWay('location', 'pos', go.Point.parse, go.Point.stringify)
        .add(
          new go.Panel('Spot')
