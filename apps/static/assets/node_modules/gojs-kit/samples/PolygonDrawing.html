  ...
  function init() {
    ...
    myDiagram.nodeTemplate =
      new go.Node({
        ...
        .bindTwoWay('angle')
        .add(
          new go.Shape({ name: 'SHAPE', fill: 'lightgray', strokeWidth: 1 })
    ...
    myDiagram.toolManager.mouseDownTools.insertAt(0, new PolygonDrawingTool({
      // provide the default JavaScript object for a new polygon in the model
      archetypePartData: { fill: 'yellow', stroke: 'blue', strokeWidth: 3 },
      isPolygon: true,
      isEnabled: false
    }));
