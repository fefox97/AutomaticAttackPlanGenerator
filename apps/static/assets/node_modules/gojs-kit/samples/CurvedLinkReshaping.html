...
<meta itemprop="description" content="Changing the curviness of a link using a single reshaping handle." />
<meta property="og:description" content="Changing the curviness of a link using a single reshaping handle." />
<meta name="twitter:description" content="Changing the curviness of a link using a single reshaping handle." />
...
<meta itemprop="name" content="Curved Link Reshaping Using Single Handle" />
<meta property="og:title" content="Curved Link Reshaping Using Single Handle" />
<meta name="twitter:title" content="Curved Link Reshaping Using Single Handle" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/curvedlinkreshaping.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/curvedlinkreshaping.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/curvedlinkreshaping.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/CurvedLinkReshaping.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/CurvedLinkReshaping.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Curved Link Reshaping Using Single Handle | GoJS Diagramming Library
    </title>
  </head>
...
<script src="../extensions/CurvedLinkReshapingTool.js"></script>
<script id="code">
  function init() {
    ...
    myDiagram.linkTemplate =
      new go.Link({ // the whole link panel
        ...
        .bindTwoWay('curviness', 'curviness') // but save "curviness" automatically
        .add(
...
<div id="sample">
  ...
  <p>
    This sample is a modification of the <a href="../samples/stateChart.html">State Chart</a> sample that makes use of the CurvedLinkReshapingTool that is
    defined in its own file, as <a href="../extensions/CurvedLinkReshapingTool.js">CurvedLinkReshapingTool.js</a>.
  </p>
  <p>
    Note that unlike the standard case of a Bezier-curved Link that is <a>Part.reshapable</a>, there is only one reshape handle When the user drags that handle,
    the value of <a>Link.curviness</a> is modified, causing the link to be curved differently. This sample also defines a TwoWay <a>Binding</a> on that
    property, thereby saving the curviness to the model data. Unlike the regular State Chart sample, there is no Binding on <a>Link.points</a>, which is no
    longer needed when the curviness is the only modified property.
  </p>
