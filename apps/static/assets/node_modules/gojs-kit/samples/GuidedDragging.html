...
<meta itemprop="description" content="A demonstration of the GuidedDraggingTool extension." />
<meta property="og:description" content="A demonstration of the GuidedDraggingTool extension." />
<meta name="twitter:description" content="A demonstration of the GuidedDraggingTool extension." />
...
<meta itemprop="name" content="Guided Dragging Shows Guidelines During Dragging for Equal Spacing between Nodes or for Aligning Nodes to other Nodes" />
<meta property="og:title" content="Guided Dragging Shows Guidelines During Dragging for Equal Spacing between Nodes or for Aligning Nodes to other Nodes" />
<meta name="twitter:title" content="Guided Dragging Shows Guidelines During Dragging for Equal Spacing between Nodes or for Aligning Nodes to other Nodes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/guideddragging.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/guideddragging.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/guideddragging.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/GuidedDragging.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/GuidedDragging.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Guided Dragging Shows Guidelines During Dragging for Equal Spacing between Nodes or for Aligning Nodes to other Nodes | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    myDiagram.nodeTemplate =
      new go.Node('Auto')
        // have various width and height nodes based on existing data properties
        .bind('width', 'text', t => Math.max(50, t.length*12))
        .bind('height', 'color', c => Math.max(30, c.length*8))
        .add(
    ...
    myDiagram.model = new go.GraphLinksModel(
      [
        ...
        { text: 'Zeta', color: 'coral' },
        { text: 'Eta', color: 'tomato' },
        { text: 'Theta', color: 'goldenrod' },
      ]
    );
  }
...
<div id="sample">
  ...
  <p>
    This custom <a>DraggingTool</a> class makes guidelines visible as a Part is dragged around a Diagram and is nearly aligned with another Part. If a
    locationObjectName is set, then this aligns <a>Part.locationObject</a>s instead. The tool is defined in its own file, as
    <a href="../extensions/GuidedDraggingTool.js">GuidedDraggingTool.js</a>.
  </p>
</div>
