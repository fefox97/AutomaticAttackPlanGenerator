...
<meta itemprop="description" content="Allow the user to shift link labels; useful when the user wants to adjust the position of the label relative to the link path to avoid overlapping the link path or any nodes." />
<meta property="og:description" content="Allow the user to shift link labels; useful when the user wants to adjust the position of the label relative to the link path to avoid overlapping the link path or any nodes." />
<meta name="twitter:description" content="Allow the user to shift link labels; useful when the user wants to adjust the position of the label relative to the link path to avoid overlapping the link path or any nodes." />
...
<meta itemprop="name" content="Dragging Link Label" />
<meta property="og:title" content="Dragging Link Label" />
<meta name="twitter:title" content="Dragging Link Label" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/linklabeldragging.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/linklabeldragging.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/linklabeldragging.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/LinkLabelDragging.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/LinkLabelDragging.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Dragging Link Label | GoJS Diagramming Library
    </title>
  </head>
...
<script src="../extensions/LinkLabelDraggingTool.js"></script>
<script id="code">
  function init() {
    ...
    myDiagram.linkTemplate =
      new go.Link({ // the whole link panel
        ...
        .add(
          ...
          new go.Panel('Auto', { cursor: 'move' }) // visual hint that the user can do something with this link label
            .bindTwoWay('segmentOffset', 'segmentOffset', go.Point.parse, go.Point.stringify)
            .add(
...
<div id="sample">
  ...
  <p>
    This sample is a modification of the <a href="../samples/stateChart.html">State Chart</a> sample that makes use of the LinkLabelDraggingTool that is defined
    in its own file, as <a href="../extensions/LinkLabelDraggingTool.js">LinkLabelDraggingTool.js</a>.
  </p>
  <p>
    Note that after dragging a link label you can move a node connected by that link and the label maintains the same position relative to the link route. That
    relative position is specified by the <a>GraphObject.segmentOffset</a> property. This sample also saves any changes to that property by means of a TwoWay
    <a>Binding</a>.
  </p>
  <p>
    See also the similar <a href="LinkLabelOnPathDragging.html" target="_blank">Link Label On Path Dragging sample</a>, where the label is constrained to remain
    on the path of the link.
  </p>
