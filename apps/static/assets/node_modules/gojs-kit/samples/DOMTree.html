...
<script id="code">
  const names = {}; // hash to keep track of what names have been used
  ...
  function getName(node) {
    ...
    let namenum = n; // make sure the name is unique
    let i = 1;
...
<div id="sample">
  ...
  <div
    id="myDiagramDiv"
    style="border: 1px solid black; width: 100%; height: 500px"></div>
  <p>
