...
<script id="code">
  function init() {
    ...
    function textStyle(node, field) {
      node.font = '12px Roboto, sans-serif';
      node.stroke = 'rgba(0, 0, 0, .60)';
      node.visible = false; // only show textblocks when there is corresponding data for them
                ...
                .add(
                  ...
                  new go.TextBlock()
                    ...
                    .bind('text', 'boss', boss => {
                      ...
                      if (boss !== null) return 'Reporting to: ' + boss.name;
                      return '';
                    })
                )
            )
    ...
    myDiagram.linkTemplate =
      new go.Link({
        ...
        .add(
          new go.Shape({ strokeWidth: 3, stroke: '#424242' }) // dark gray, rounded corner links
        );
  ...
  function searchDiagram() {
    ...
    if (input.value) {
      ...
      if (results.count > 0) myDiagram.commandHandler.scrollToPart(results.first());
    } else {
