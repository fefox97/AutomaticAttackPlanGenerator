...
<meta itemprop="description" content="Allow the user to shift the rotation point as well as rotate objects by using the SpotRotatingTool extension." />
<meta property="og:description" content="Allow the user to shift the rotation point as well as rotate objects by using the SpotRotatingTool extension." />
<meta name="twitter:description" content="Allow the user to shift the rotation point as well as rotate objects by using the SpotRotatingTool extension." />
...
<meta itemprop="name" content="Rotating Node about Movable Rotation Spot" />
<meta property="og:title" content="Rotating Node about Movable Rotation Spot" />
<meta name="twitter:title" content="Rotating Node about Movable Rotation Spot" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/spotrotating.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/spotrotating.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/spotrotating.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/SpotRotating.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/SpotRotating.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Rotating Node about Movable Rotation Spot | GoJS Diagramming Library
    </title>
  </head>
...
<script src="../extensions/SpotRotatingTool.js"></script>
<script id="code">
  function init() {
    ...
    myDiagram.nodeTemplate =
      new go.Node('Spot', {
        ...
        .bindTwoWay('rotationSpot', 'rotSpot', go.Spot.parse, go.Spot.stringify)
        .add(
...
<div id="sample">
  ...
  <p>
    The user can resize and rotate the Shape named "SHAPE" in the Nodes. In addition to the normal features of the RotatingTool, the SpotRotatingTool shows a
    handle at the <a>Part.rotationSpot</a>, which is also at the <a>RotatingTool.rotationPoint</a>. The user can drag that handle and thereby move the
    rotationPoint and the <a>Part.rotationSpot</a>. When the handle is inside the rectangular area of the <a>Part.rotateObject</a>, the Spot is purely
    fractional. When the handle moves outside of the object's rectangular area, the spot will be at the edge of the rectangle plus an offset.
  </p>
  <p>This extension tool is defined in its own file, as <a href="../extensions/SpotRotatingTool.js">SpotRotatingTool.js</a>.</p>
  <p>
    Auto updating Model Data:
  </p>
  <pre class="lang-js"><code id="mySavedModel" style="width: 100%; height: 200px"></code></pre>
</div>
