      ...
      <div style="border: solid 1px black; padding: 5px">
        ...
        <p id="autoP">
          ...
          <input type="radio" name="autoScale" onclick="changeAutoScale(this.value)" id="DiagramNone" value="None" checked /><label for="DiagramNone"
            >AutoScale.None</label
          ><br />
          <input type="radio" name="autoScale" onclick="changeAutoScale(this.id)" id="Uniform" /><label for="Uniform">AutoScale.Uniform</label><br />
          <input type="radio" name="autoScale" onclick="changeAutoScale(this.id)" id="UniformToFill" /><label for="UniformToFill">AutoScale.UniformToFill</label
          ><br />
