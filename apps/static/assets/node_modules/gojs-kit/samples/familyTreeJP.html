...
<meta itemprop="description" content="A family tree diagram showing Japanese royalty." />
<meta property="og:description" content="A family tree diagram showing Japanese royalty." />
<meta name="twitter:description" content="A family tree diagram showing Japanese royalty." />
...
<meta itemprop="name" content="Family Tree Diagram, Japanese" />
<meta property="og:title" content="Family Tree Diagram, Japanese" />
<meta name="twitter:title" content="Family Tree Diagram, Japanese" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/familytreejp.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/familytreejp.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/familytreejp.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/familyTreeJP.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/familyTreeJP.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Family Tree Diagram, Japanese | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    const bluegrad = new go.Brush('Linear', { 0: 'rgb(60, 204, 254)', 1: 'rgb(70, 172, 254)' });
    const pinkgrad = new go.Brush('Linear', { 0: 'rgb(255, 192, 203)', 1: 'rgb(255, 142, 203)' });
    ...
    myDiagram.add(
      new go.Part('Table', {
        ...
        .add(
          new go.TextBlock('Key', { row: 0, font: 'bold 10pt Helvetica, Arial, sans-serif' }), // end row 0
          new go.Panel('Horizontal', { row: 1, alignment: go.Spot.Left })
            .add(
              ...
              new go.TextBlock('Males', { font: 'bold 8pt Helvetica, bold Arial, sans-serif' })
            ), // end row 1
          new go.Panel('Horizontal', { row: 2, alignment: go.Spot.Left })
            .add(
              ...
              new go.TextBlock('Females', { font: 'bold 8pt Helvetica, bold Arial, sans-serif' })
            ) // end row 2
        )
      );
    ...
    const tooltiptemplate = go.GraphObject.build('ToolTip', {
    ...
    const nodeDataArray = [
      ...
      },
      {
        ...
        birthYear: '1896',
        deathYear: '1978',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        key: 3,
        parent: 2,
      ...
      { key: 19, parent: 9, name: 'Sachiko', gender: 'F', fullTitle: 'Princess Sachiko', kanjiName: '久宮祐子', birthYear: '1927', deathYear: '1928' },
      {
        ...
        birthYear: '1929',
        deathYear: '1989',
        statusChange: 'In 1950, lost imperial family status by marrying a commoner'
      },
      {
        key: 21,
        parent: 9,
        ...
        kanjiName: '池田厚子',
        birthYear: '1931',
        statusChange: 'In 1952, lost imperial family status by marrying a commoner'
      },
      {
        key: 22,
        parent: 9,
      ...
      },
      {
        ...
        name: 'Naruhito',
        gender: 'M',
        fullTitle: 'Naruhito, Crown Prince of Japan',
        kanjiName: '皇太子徳仁親王',
        orderInSuccession: '1',
        birthYear: '1960'
      },
      { key: 24, parent: 23, name: 'Aiko', gender: 'F', fullTitle: 'Aiko, Princess Toshi', kanjiName: '敬宮愛子内親王', birthYear: '2001' },
      {
        ...
        name: 'Fumihito',
        gender: 'M',
        fullTitle: 'Fumihito, Prince Akishino',
        kanjiName: '秋篠宮文仁親王',
        orderInSuccession: '2',
        birthYear: '1965'
      },
      ...
      { key: 27, parent: 25, name: 'Kako', gender: 'F', fullTitle: 'Princess Kako of Akishino', kanjiName: '佳子内親王', birthYear: '1994' },
      {
        ...
        name: 'Hisahito',
        gender: 'M',
        fullTitle: 'Prince Hisahito of Akishino',
        kanjiName: '悠仁親王',
        orderInSuccession: '3',
        birthYear: '2006'
      },
      {
        ...
        name: 'Sayako Kuroda',
        gender: 'F',
        fullTitle: 'Princess Sayako of Japan',
        kanjiName: '黒田清子',
        birthYear: '1969',
        statusChange: 'In 2005, lost imperial family status by marrying a commoner'
      },
      {
        key: 30,
        parent: 9,
        name: 'Masahito',
        gender: 'M',
        fullTitle: 'Masahito, Prince Hitachi',
        kanjiName: '常陸宮正仁親王',
        orderInSuccession: '4',
        birthYear: '1935'
      },
      {
        ...
        name: 'Takako Shimazu',
        gender: 'F',
        fullTitle: 'Princess Takako',
        kanjiName: '島津貴子',
        birthYear: '1939',
        statusChange: 'In 1960, lost imperial family status by marrying a commoner'
      },
      { key: 32, parent: 31, name: 'Yorihisa Shimazu', gender: 'M', fullTitle: 'No Title', birthYear: '1962' },
      {
        ...
        name: 'Yasuhito',
        gender: 'M',
        fullTitle: 'Yasuhito, Prince Chichibu of Japan',
        kanjiName: '秩父宮 雍仁',
        birthYear: '1902',
        deathYear: '1953'
      },
      {
        ...
        name: 'Nobuhito',
        gender: 'M',
        fullTitle: 'Nobuhito, Prince Takamatsu',
        kanjiName: '高松宮宣仁親王',
        birthYear: '1905',
        deathYear: '1987'
      },
      {
        ...
        name: 'Takahito',
        gender: 'M',
        fullTitle: 'Takahito, Prince Mikasa',
        kanjiName: '三笠宮崇仁親王',
        orderInSuccession: '5',
        birthYear: '1915'
      },
      {
        ...
        name: 'Yasuko Konoe',
        gender: 'F',
        fullTitle: 'Princess Yasuko of Mikasa',
        kanjiName: '甯子内親王',
        birthYear: '1944',
        statusChange: 'In 1966, lost imperial family stutus by marrying a commoner'
      },
      { key: 37, parent: 36, name: 'Tadahiro', gender: 'M', fullTitle: 'None' },
      {
        ...
        name: 'Tomihito',
        gender: 'M',
        fullTitle: 'Prince Tomohito of Mikasa',
        kanjiName: '三笠宮寬仁',
        orderInSuccession: '6',
        birthYear: '1946'
      },
      ...
      { key: 40, parent: 38, name: 'Yoko', gender: 'F', fullTitle: 'Princess Yoko of Mikasa', kanjiName: '瑶子女王', birthYear: '1983' },
      {
        ...
        name: 'Yoshihito',
        gender: 'M',
        fullTitle: 'Yoshihito, Prince Katsura',
        kanjiName: '桂宮 宜仁親王',
        orderInSuccession: '7',
        birthYear: '1948'
      },
      {
        ...
        name: 'Masako Sen',
        gender: 'F',
        fullTitle: 'Princess Masako of Mikasa',
        kanjiName: '容子内親王',
        birthYear: '1951',
        statusChange: 'In 1983, lost imperial family status by marrying a commoner'
      },
      ...
      { key: 45, parent: 42, name: 'Makiko', gender: 'F', fullTitle: 'No Title' },
      {
        ...
        name: 'Norihito',
        gender: 'M',
        fullTitle: 'Norihito, Prince Takamado',
        kanjiName: '高円宮憲仁親王',
        birthYear: '1954',
        deathYear: '2002'
      },
      ...
      { key: 50, parent: 1, name: 'Masako', gender: 'F', fullTitle: 'Princess Masako of Tsune', birthYear: '1888', deathYear: '1940' },
      {
        key: 51,
        parent: 50,
        name: 'Takeda Tsuneyoshi',
        gender: 'M',
        fullTitle: 'Prince Takeda Tsunehisa',
        kanjiName: '竹田宮恒徳王',
        birthYear: '1909',
        deathYear: '1992',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        key: 52,
        parent: 51,
        name: 'Takeda Tsunetada',
        gender: 'M',
        fullTitle: 'Prince Takeda Tsunetada',
        kanjiName: '竹田恒正王',
        birthYear: '1940',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      ...
      { key: 54, parent: 52, name: 'Takeda Hiroko', gender: 'M', fullTitle: 'No Title', birthYear: '1971' },
      {
        ...
        name: 'Takeda Motoko',
        gender: 'F',
        fullTitle: 'Princess Takeda Motoko',
        kanjiName: '素子女王',
        birthYear: '1942',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      ...
      },
      {
        ...
        name: 'Takeda Noriko',
        gender: 'F',
        fullTitle: 'Princess Takeda Noriko',
        kanjiName: '紀子女王',
        birthYear: '1943',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        ...
        gender: 'M',
        fullTitle: 'Prince Tsuneharu Takeda',
        kanjiName: '竹田恒治王',
        birthYear: '1945',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        ...
        name: 'Takeda Ayako',
        gender: 'F',
        fullTitle: 'Princess Tsune-no-Miya Takeda Ayako',
        kanjiName: '禮子女王',
        birthYear: '1911',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      { key: 60, parent: 1, name: 'Fusako', gender: 'F', fullTitle: 'Princess Fusako of Kane', birthYear: '1890', deathYear: '1974' },
      {
        key: 61,
        parent: 60,
        name: 'Kitashirakawa Nagahisa',
        gender: 'M',
        fullTitle: 'Prince Kitashirakawa Nagahisa',
        kanjiName: '北白川宮永久王',
        birthYear: '1910',
        deathYear: '1940'
      },
      {
        key: 62,
        parent: 61,
        name: 'Kitashirakawa Michihisa',
        gender: 'M',
        fullTitle: 'Prince Kitashirakawa Michihisa',
        birthYear: '1937',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      ...
      },
      {
        key: 67,
        parent: 60,
        name: 'Kitashirakawa Mineko',
        gender: 'F',
        fullTitle: 'Princess Kitashirakawa Mineko',
        kanjiName: '美年子女王',
        birthYear: '1910',
        deathYear: '1970',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        key: 68,
        parent: 60,
        name: 'Kitashirakawa Sawako',
        gender: 'F',
        fullTitle: 'Princess Kitashirakawa Sawako',
        kanjiName: '佐和子女王',
        birthYear: '1913',
        deathYear: '2001',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        key: 69,
        parent: 60,
        name: 'Kitashirakawa Taeko',
        gender: 'F',
        fullTitle: 'Princess Kitashirakawa Taeko',
        kanjiName: '多惠子女王',
        birthYear: '1920',
        deathYear: '1954',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      ...
      { key: 70, parent: 1, name: 'Nobuko', gender: 'F', fullTitle: 'Princess Fumi-no-Miya Nobuko', birthYear: '1891', deathYear: '1933' },
      {
        ...
        name: 'Asaka Kikuko',
        gender: 'F',
        fullTitle: 'Princess Asaka Kikuko',
        kanjiName: '紀久子',
        birthYear: '1911',
        deathYear: '1989',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
      {
        ...
        name: 'Asaka Takahiko',
        gender: 'M',
        fullTitle: 'Prince Asaka Takahiko',
        kanjiName: '朝香 孚彦',
        birthYear: '1913',
        deathYear: '1994',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      ...
      { key: 75, parent: 72, name: 'Tomohiko', gender: 'M', fullTitle: 'No Title' },
      {
        ...
        name: 'Asaka Tadahito',
        gender: 'M',
        fullTitle: 'Prince Asaka Tadahito',
        kanjiName: '朝香正彦',
        birthYear: '1914',
        deathYear: '1944'
      },
      {
        ...
        name: 'Asaka Kiyoko',
        gender: 'F',
        fullTitle: 'Princess Asaka Kiyoko',
        kanjiName: '湛子',
        birthYear: '1919',
        statusChange: 'In 1947, lost imperial family status due to American abrogation of Japanese nobility'
      },
