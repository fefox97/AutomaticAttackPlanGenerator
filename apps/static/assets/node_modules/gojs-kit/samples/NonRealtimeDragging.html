...
<meta itemprop="description" content="A modification of DraggingTool to show a ghost image of what is being moved, rather than moving the nodes and links in realtime." />
<meta property="og:description" content="A modification of DraggingTool to show a ghost image of what is being moved, rather than moving the nodes and links in realtime." />
<meta name="twitter:description" content="A modification of DraggingTool to show a ghost image of what is being moved, rather than moving the nodes and links in realtime." />
...
<meta itemprop="name" content="Dragging Image of Selection Rather Than Moving Them in Realtime" />
<meta property="og:title" content="Dragging Image of Selection Rather Than Moving Them in Realtime" />
<meta name="twitter:title" content="Dragging Image of Selection Rather Than Moving Them in Realtime" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/nonrealtimedragging.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/nonrealtimedragging.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/nonrealtimedragging.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/NonRealtimeDragging.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/NonRealtimeDragging.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Dragging Image of Selection Rather Than Moving Them in Realtime | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    myDiagram = new go.Diagram('myDiagramDiv', {
      ...
      draggingTool: new NonRealtimeDraggingTool({ duration: 600 }),
...
<div id="sample">
  ...
  <p>
    This custom <a>DraggingTool</a> class causes the user to drag around a translucent image of the Nodes and Links being moved, leaving the selected Parts in
    place, rather than actually moving those Nodes and Links in realtime. Only when the mouse up occurs does the move happen.
  </p>
  <p>This tool is defined in its own file, as <a href="../extensions/NonRealtimeDraggingTool.js">NonRealtimeDraggingTool.js</a></p>
</div>
