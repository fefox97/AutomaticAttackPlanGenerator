...
<meta itemprop="description" content="A re-implementation of the default text editor, implemented by the TextEditor extension." />
<meta property="og:description" content="A re-implementation of the default text editor, implemented by the TextEditor extension." />
<meta name="twitter:description" content="A re-implementation of the default text editor, implemented by the TextEditor extension." />
...
<meta itemprop="name" content="Standard HTMLInfo Text Editor" />
<meta property="og:title" content="Standard HTMLInfo Text Editor" />
<meta name="twitter:title" content="Standard HTMLInfo Text Editor" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/texteditor.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/texteditor.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/texteditor.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/TextEditor.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/TextEditor.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Standard HTMLInfo Text Editor | GoJS Diagramming Library
    </title>
  </head>
...
<script src="../extensions/TextEditor.js"></script>
<script id="code">
  function init() {
...
<div id="sample">
  ...
  <p>
    The implementation is contained in the file <a href="../extensions/TextEditor.js" target="_blank">TextEditor.js</a> and exposes <code>window.TextEditor</code>, which is
    used in this file as the value of <code>myDiagram.toolManager.textEditingTool.defaultTextEditor</code>.
  </p>

  <p>
    This also adds a text validation predicate, <code>okName</code>, as the <a>TextBlock.textValidation</a> property. That predicate makes sure that the new
