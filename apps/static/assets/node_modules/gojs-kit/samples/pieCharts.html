...
<meta itemprop="description" content="GoJS nodes containing simple pie charts, each slice showing a tooltip." />
<meta property="og:description" content="GoJS nodes containing simple pie charts, each slice showing a tooltip." />
<meta name="twitter:description" content="GoJS nodes containing simple pie charts, each slice showing a tooltip." />
...
<meta itemprop="name" content="Pie Charts in Nodes" />
<meta property="og:title" content="Pie Charts in Nodes" />
<meta name="twitter:title" content="Pie Charts in Nodes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/piecharts.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/piecharts.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/piecharts.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/pieCharts.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/pieCharts.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Pie Charts in Nodes | GoJS Diagramming Library
    </title>
  </head>
  ...
  function init() {
                        ...
                        go.GraphObject.build('ToolTip')
                          .add(
                            new go.TextBlock({ margin: 4 })
                              .bind('text', '', data => data.color + ': ' + data.start + ' to ' + (data.start + data.sweep))
                          )
                    })
                    .add(
                      new go.Shape({ fill: 'lightgreen', isGeometryPositioned: true })
                        .bind('fill', 'color')
    ...
    function makeGeo(data) {
      return new go.Geometry()
        .add(
          new go.PathFigure(50, 50) // start point
            .add(
              new go.PathSegment(
                go.SegmentType.Arc,
                data.start,
...
<div id="sample">
  ...
  <p>
    Each node has a Position Panel whose <a>Panel.itemArray</a> is data bound to the "slices" property of the node data. That "slices" property is an Array of
    data objects; for each item the <a>Panel.itemTemplate</a> produces a Shape whose <a>Shape.geometry</a> is computed using a conversion function to generate a
    pie-shaped slice given a start angle and a sweep angle from the item data. Note that <a>Shape.isGeometryPositioned</a> is true to make sure all of the
    Shapes are positioned by their computed geometries, independent of any stroke width. Each slice Panel also has a tooltip showing some information.
  </p>
  <p>For more sophisticated charts within nodes, see the <a href="canvases.html">Canvas Charts</a> sample.</p>
</div>
