...
<script id="code">
  ...
  function init() {
    ...
    myDiagram.addDiagramListener('ViewportBoundsChanged', e => {
      ...
      currentScale = scaleMult * origscale / newscale;
      myDiagram.parts.each(p => {
        if (p.layerName !== 'Adornment') return; // don't scale background image
  ...
  function createEvent(node, diaTxt, logTxt) {
    ...
    const p =
      new go.Part('Auto', { pickable: false, layerName: 'Adornment', scale: currentScale })
        .add(
          new go.Shape('RoundedRectangle', { fill: 'white' }),
          new go.TextBlock(diaTxt, { margin: 8 })
        );
    myDiagram.add(p);
...
<div id="sample">
  ...
  <div class="w-full flex flex-wrap">
    ...
    <div class="flex-none w-[500px] min-h-[200px] flex flex-col mb-4">
      Event Log
      <textarea id="outputLog" style="width: 100%; height: 100%;resize: none;" autocomplete="off"></textarea>
    </div>
  </div>
  ...
  <br>
  <textarea id="mySavedModel" style="width: 90%;height: 400px" autocomplete="off">
{ "class": "GraphLinksModel",
  "nodeDataArray": [
{"category":"door","loc":"535 641.85","ang":270,"width":62.7,"height":15,"key":"sub office 1"},
{"category":"door","loc":"588.45 665","width":56.1,"height":15,"key":"office 1"},
{"category":"door","loc":"721.8 738","key":"bath 1","width":48.4,"height":15},
{"category":"door","loc":"942.4 664","key":"office 2","width":57.2,"height":15},
{"category":"door","loc":"401.45 942","key":"main entrance","width":100.1,"height":15},
{"loc":"715 1125.35","category":"door","key":"lounge 1","ang":270,"width":62.7,"height":15},
{"loc":"721.2 1007","category":"door","key":"storage 1","width":61.6,"height":15},
{"loc":"1119.25 738","category":"door","key":"meeting 1","width":60.5,"height":15},
{"loc":"1607.2 407","category":"door","key":"meeting 2","width":61.6,"height":15},
{"loc":"2133 671.2","category":"door","key":"office 3","ang":90,"width":61.6,"height":15},
{"loc":"2310 669.65","category":"door","key":"second entrance","ang":90,"width":62.7,"height":15},
{"loc":"1996.25 407","category":"door","key":"lounge 2","width":60.5,"height":15},
{"loc":"1808.75 561","category":"door","key":"bath 2","width":49.5,"height":15},
{"loc":"1898.7 561","category":"door","key":"bath 3","width":50.6,"height":15},
{"loc":"2310 947.15","category":"door","key":"sub office 4","ang":90,"width":62.7,"height":15},
{"loc":"2133 935.35","category":"door","key":"sub office 2","ang":270,"width":62.7,"height":15},
{"loc":"2133 949.2","category":"door","key":"sub office 3","ang":90,"width":61.6,"height":15},
{"loc":"2285.8 1018","category":"door","key":"sub office 5","width":61.6,"height":15,"ang":180},
{"loc":"2310 568.75","category":"door","key":"office 4","width":60.5,"height":15,"ang":90},
{"loc":"2310 451.1","category":"door","key":"storage 2","ang":90,"width":63.8,"height":15},
{"loc":"2310 371.25","category":"door","key":"meeting 3","ang":270,"width":60.5,"height":15},
{"status":"Camera offline since 6/30/2025, 11:06:17 AM","loc":"546 675","category":"camera","sweep":90,"radius":160,"key":1},
