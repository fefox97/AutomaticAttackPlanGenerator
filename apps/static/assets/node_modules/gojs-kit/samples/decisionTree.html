...
<script id="code">
  function init() {
      ...
      new go.Node('Auto')
        ...
        .add(
          ...
          new go.Panel('Horizontal')
            .add(
              new go.TextBlock({ font: '30px Roboto, sans-serif', margin: 5 })
                .bind('text', 'key'),
              ...
              new go.Panel('Vertical', { defaultStretch: go.Stretch.Fill, margin: 3 })
                .add(
                  go.GraphObject.build('Button', { // button A
                    ...
                    .bind('portId', 'a')
                    .add(
                      new go.TextBlock({ font: '900 16px Roboto, sans-serif' })
                        .bind('text', 'aText')
                    ), // end button A
    ...
    myDiagram.linkTemplate =
      new go.Link({ routing: go.Routing.Orthogonal, fromPortId: '' }) // the whole link panel
