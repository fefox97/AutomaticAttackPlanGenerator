...
<meta itemprop="description" content="A diagram for displaying and editing the N to M relationships from one set of objects to another set of objects." />
<meta property="og:description" content="A diagram for displaying and editing the N to M relationships from one set of objects to another set of objects." />
<meta name="twitter:description" content="A diagram for displaying and editing the N to M relationships from one set of objects to another set of objects." />
...
<meta itemprop="name" content="Record Mapper Diagram Editor Relating Fields to Fields" />
<meta property="og:title" content="Record Mapper Diagram Editor Relating Fields to Fields" />
<meta name="twitter:title" content="Record Mapper Diagram Editor Relating Fields to Fields" />
...
<meta property="og:url" content="https://gojs.net/latest/samples/records.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/records.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Record Mapper Diagram Editor Relating Fields to Fields | GoJS Diagramming Library
    </title>
  </head>
...
<div id="sample">
  ...
  <p>
    This record mapper shows a number of "fields" for each "record" and how they are mapped between
    each other.
  </p>
  <p>
    Draw new links by dragging from the background of any field. Reconnect a selected link by
    dragging its diamond-shaped handle. The "record" Nodes use a
    <a>Panel.Table</a> to place the various fields into rows. Records are not copyable or deletable.
  </p>
  <p>
    For a variation on this sample with selectable fields in the record nodes, see the
    <a href="selectableFields.html">selectable fields</a> sample.
  </p>
  <div>
