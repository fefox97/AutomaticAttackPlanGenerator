  ...
  function init() {
    ...
    myDiagram.nodeTemplate =
      new go.Node('Auto', {
        ...
        .add(
          new go.Shape({ strokeWidth: 0, fill: 'lightgray' })
            .bind('fill', 'color'),
      ...
      new DimensioningLink()
        ...
        .add(
          new go.Shape({ stroke: 'gray' })
            .bind('stroke', 'color'),
          new go.Shape({ fromArrow: 'BackwardOpenTriangle', segmentIndex: 2, stroke: 'gray' })
            .bind('stroke', 'color'),
          new go.Shape({ toArrow: 'OpenTriangle', segmentIndex: -3, stroke: 'gray' })
            .bind('stroke', 'color'),
          new go.TextBlock({
              segmentIndex: 2,
              segmentFraction: 0.5,
