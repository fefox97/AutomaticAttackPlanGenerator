...
<meta property="og:url" content="https://gojs.net/latest/samples/floorplannerTS/" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/floorplannerTS/" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Sample | GoJS Diagramming Library
    </title>
  </head>
...
<body>
  <div>
    <nav>
      <ul id="ge-filemenus">
        <li>
          <a href="#">View</a>
          <ul>
            <li id="ge-viewoption-palettes"><a href="#"
                onclick="editorHelper.geHideShowWindow('ge-palettes-window', true)"
                id="ge-palettes-windows-button">Palettes
                <p class="ge-shortcut"> (Ctrl + P)</p>
              </a></li>
            <li id="ge-viewoption-overviews"><a href="#"
                onclick="editorHelper.geHideShowWindow('ge-overviews-window', true)"
                id="ge-overview-windows-button">Overview
                <p class="ge-shortcut"> (Ctrl + E)</p>
              </a></li>
            <li id="ge-viewoption-inspector"><a href="#"
                onclick="editorHelper.geHideShowWindow('ge-inspector-window', true)"
                id="ge-inspector-windows-button">Inspector
                <p class="ge-shortcut"> (Ctrl + I)</p>
              </a></li>
            <li id="ge-viewoption-options"><a href="#" onclick="editorHelper.geHideShowWindow('optionsWindow', true)"
                id="optionsWindow-button">Options<p class="ge-shortcut">(Ctrl + B)</p></a></li>
          </ul>
        </li>
      </ul>
    ...
    <div id="ge-palettes-window" style="visibility: visible" class="ge-draggable ui-draggable">
      <div id="ge-palettes-window-handle" class="ge-handle ui-draggable-handle">Palettes<button
          id="ge-palettes-window-close" class="ge-window-button ge-clickable"
          onclick="editorHelper.geHideShowWindow('ge-palettes-window')">X</button></div>
    ...
    <div id="ge-overviews-window" style="visibility: visible" class="ge-draggable ui-draggable">
      <div id="ge-overviews-window-handle" class="ge-handle ui-draggable-handle">Overview<button
          id="ge-overviews-window-close" class="ge-window-button ge-clickable"
          onclick="editorHelper.geHideShowWindow('ge-overviews-window')">X</button></div>
  ...
  <div id="ge-inspector-window" style="visibility: visible" class="ge-draggable ui-draggable">
    <div id="ge-inspector-window-handle" class="ge-handle ui-draggable-handle">Properties<button
        id="ge-inspector-window-close" class="ge-window-button ge-clickable"
        onclick="editorHelper.geHideShowWindow('ge-inspector-window')">X</button></div>
    <div id="ge-inspector" class="inspector"></div>
  </div>

  <div id="optionsWindow" style="visibility: hidden;" class="ge-draggable ui-draggable">
    <div id="optionsWindow-handle" class="ge-handle ui-draggable-handle">Options <button id="optionsWindowClose"
        class="windowButtons ge-window-button ge-clickable"
    ...
    <div id="gridRow" class="row">
      <div class="col-2">
        ...
        <input id="gridSizeInput" placeholder="" class="unitsInput" onchange="myFloorplan.changeGridSize(this)"
          value="20" />
        <input id="gridSizeUnitsInput" class="unitsBox" value="cm" disabled />
      </div>
      <div class="col-2">
        <input type="checkbox" id="showGridCheckbox" onchange="myFloorplan.checkboxChanged('showGridCheckbox')"
          checked />Show
        Grid
      </div>
    </div>
    <div id="gridRow" class="row">
      <div class="col-1">
        ...
        <input id="unitsConversionFactorInput" placeholder=""
    ...
    <div id="miscRow" class="row data">
      <div class="col-1">
        <input type="checkbox" id="gridSnapCheckbox" onchange="myFloorplan.checkboxChanged('gridSnapCheckbox')"
          checked />Grid
        Snap
      </div>
      <div class="col-1">
        <input type="checkbox" id="wallGuidelinesCheckbox"
          onchange="myFloorplan.checkboxChanged('wallGuidelinesCheckbox')" checked /> Show Wall Guidelines
      </div>
      <div class="col-1">
      ...
      <div class="col-1">
        <input type="checkbox" id="onlySmallWallAnglesCheckbox"
          onchange="myFloorplan.checkboxChanged('onlySmallWallAnglesCheckbox')" checked /> Show Only Non-Reflex Wall
        Angles
      </div>
    </div>
  </div>
  ...
  <p>
    This Floorplanner sample of GoJS makes use of multiple classes to allow for users to build, edit, save, and load
  ...
  <ul>
    <li><a href="./src/Floorplan.ts">Floorplan.ts</a> - A special kind of <a
        href="../../api/symbols/Diagram.html">Diagram</a>
      with listeners, properties, and methods that help with floorplanning </li>
    <li><a href="./src/FloorplanPalette.ts">FloorplanPalette.ts</a> - A special kind of <a
        href="../../api/symbols/Palette.html">Palette</a>
  ...
  <p>
    To modify this sample, one must modify the .ts source files (in this project's 'src' directory'), then run
    <code>tsc</code>.
  </p>
...
{"key":"wall29", "category":"WallGroup", "caption":"Divider", "type":"Divider", "color":"lightgray", "startpoint":{"class":"go.Point", "x":100, "y":-100}, "endpoint":{"class":"go.Point", "x":100, "y":-20}, "smpt1":{"class":"go.Point", "x":99.9975, "y":-99.99896446609407}, "smpt2":{"class":"go.Point", "x":100.0025, "y":-100.00103553390593}, "empt1":{"class":"go.Point", "x":99.9975, "y":-20.00103553390593}, "empt2":{"class":"go.Point", "x":100.0025, "y":-19.99896446609407}, "thickness":0.005, "isGroup":true, "notes":"", "isDivider":true}
  ...
  <script type="module">
    ...
    import { init } from "./src/FloorplannerScript.js";
    init(jQuery);
  </script>
</body>
