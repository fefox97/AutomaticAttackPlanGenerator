...
function makeFurnitureRotateAdornmentTemplate() {
  ...
  return $(go.Adornment,
    $(go.Shape,
      ...
      /*new go.Binding('fill', '', obj => (obj.adornedPart === null) ? '#ffffff' : obj.adornedPart.data.color).ofObject(),
      new go.Binding('stroke', '', obj => (obj.adornedPart === null) ? '#000000' : obj.adornedPart.data.stroke).ofObject()*/
    )
  );
}
