...
export class FloorplanPalette extends go.Palette {
    constructor(div, floorplan /*, nodeDataArray: Array<any>*/) {
        ...
        this.nodeTemplateMap.add('FloorNode', $(go.Node, 'Auto', $(go.Shape, { fill: makeFloorBrush(null), desiredSize: new go.Size(100, 100) }, new go.Binding('fill', 'floorImage', function (src) {
