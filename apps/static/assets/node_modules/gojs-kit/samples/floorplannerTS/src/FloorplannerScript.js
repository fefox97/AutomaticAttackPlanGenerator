...
export function init(JQUERY) {
    ...
    myFloorplan.addDiagramListener('InitialLayoutCompleted', function (e) {
        ...
        const showWallGuidelinesCheckbox = document.getElementById('wallGuidelinesCheckbox');
        const showWallLengthsCheckbox = document.getElementById('wallLengthsCheckbox');
        const showWallAnglesCheckbox = document.getElementById('wallAnglesCheckbox');
        const showOnlySmallWallAnglesCheckbox = document.getElementById('onlySmallWallAnglesCheckbox');
