...
<meta itemprop="description" content="Minimal, showing SVG rendering and download with Diagram.makeSvg." />
<meta property="og:description" content="Minimal, showing SVG rendering and download with Diagram.makeSvg." />
<meta name="twitter:description" content="Minimal, showing SVG rendering and download with Diagram.makeSvg." />
...
<meta itemprop="name" content="Minimal SVG Download Using MakeSvg" />
<meta property="og:title" content="Minimal SVG Download Using MakeSvg" />
<meta name="twitter:title" content="Minimal SVG Download Using MakeSvg" />
...
<meta property="og:url" content="https://gojs.net/latest/samples/minimalSvg.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/minimalSvg.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Minimal SVG Download Using MakeSvg | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    document.getElementById('svgButton').addEventListener('click', () => {
      myDiagram.commandHandler.downloadSvg({ name: "mySVGfile.svg" });
    });
  }
...
<div id="sample">
  ...
  <p>This sample shows how to use <a>Diagram.makeSvg</a> function to render all or part of a diagram and to initiate a file download.</p>
</div>
