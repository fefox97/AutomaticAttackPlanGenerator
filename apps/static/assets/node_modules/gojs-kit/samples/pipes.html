...
<meta itemprop="name" content="Pipes Diagram Editor for Snapping Pipe Sections Together and Rotating Them" />
<meta property="og:title" content="Pipes Diagram Editor for Snapping Pipe Sections Together and Rotating Them" />
<meta name="twitter:title" content="Pipes Diagram Editor for Snapping Pipe Sections Together and Rotating Them" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/pipes.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/pipes.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/pipes.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/pipes.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/pipes.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Pipes Diagram Editor for Snapping Pipe Sections Together and Rotating Them | GoJS Diagramming Library
    </title>
  </head>
  ...
  function init() {
    ...
    myDiagram.nodeTemplateMap.add('Comment',
      new go.Node()
        ...
        .add(
          new go.TextBlock({ stroke: 'brown', font: '9pt sans-serif' })
            .bind('text')
        )
    );
            ...
            new go.Panel()
              ...
              .add(
                new go.Shape('XLine', {
                  ...
                  .bind('figure', 'id', portFigure) // portFigure converter is defined below
                  .bind('angle', 'angle')
              ),
...
<div id="sample">
  ...
  <div
    id="myDiagramDiv"
    style="border: solid 1px black; width: 100%; height: 500px; margin-top: 3px"></div>
  <p>
    Nodes in this sample use <a>Shape.geometryString</a> to determine their shape. You can see more
    custom geometry examples and read about geometryString on the
    <a href="../intro/geometry.html">Geometry Path Strings Introduction page.</a>
  </p>
  <p>
    As a part's unconnected port (shown by an X) comes close to a stationary port with which it is
    compatible, the dragged selection snaps so that those ports coincide. A custom
    <a>DraggingTool</a>, called <b>SnappingTool</b>, is used to check compatibility.
  </p>
  <p>
    Dragging automatically drags all connected parts. Hold down the Shift key before dragging in
    order to detach a part from the parts it is connected with. These functionalities are also
    controlled by the custom SnappingTool.
  </p>
  <p>
    Use the <a>GraphObject.contextMenu</a> to rotate, detach, or delete a node. If it is connected
    with other parts, the whole collection rotates.
  </p>
  <div>
    <div>
