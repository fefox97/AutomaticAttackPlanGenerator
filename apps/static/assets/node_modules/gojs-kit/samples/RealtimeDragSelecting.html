...
<meta itemprop="description" content="This customized DragSelectingTool selects and deselects parts continuously while the user is dragging a box, rather than when the tool finishes." />
<meta property="og:description" content="This customized DragSelectingTool selects and deselects parts continuously while the user is dragging a box, rather than when the tool finishes." />
<meta name="twitter:description" content="This customized DragSelectingTool selects and deselects parts continuously while the user is dragging a box, rather than when the tool finishes." />
...
<meta itemprop="name" content="Realtime Selection During Background Dragging" />
<meta property="og:title" content="Realtime Selection During Background Dragging" />
<meta name="twitter:title" content="Realtime Selection During Background Dragging" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/realtimedragselecting.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/realtimedragselecting.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/realtimedragselecting.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/RealtimeDragSelecting.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/RealtimeDragSelecting.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Realtime Selection During Background Dragging | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    myDiagram = new go.Diagram('myDiagramDiv', {
      ...
      dragSelectingTool: new RealtimeDragSelectingTool({
      ...
      nodeTemplate:
        new go.Node('Spot', { width: 70, height: 20 })
          .add(
...
<div id="sample">
  ...
  <p>
    This sample demonstrates the RealtimeDragSelectingTool, which replaces the standard <a>DragSelectingTool</a>. Press in the background, wait briefly, and
    then drag to start selecting Nodes or Links that intersect with the box. You can press or release Control (Command on Mac) or Shift while dragging to see
    how the selection changes.
  </p>
  <p>
    Load it in your own app by including <a href="../extensions/RealtimeDragSelectingTool.js">RealtimeDragSelectingTool.js</a>. Initialize your Diagram by setting
    <a>ToolManager.dragSelectingTool</a> to a new instance of this tool. For example:
  </p>
...
new go.Diagram({
  . . .,
  "toolManager.dragSelectingTool": new RealtimeDragSelectingTool({ isPartialInclusion: true }),
  . . .
})
  </code></pre>
</div>
