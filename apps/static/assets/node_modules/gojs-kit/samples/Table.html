  ...
  function init() {
    ...
    myDiagram.nodeTemplateMap.add('Header', // an overall table header, at the top
      new go.Part('Auto', {
        ...
        .add(
          ...
          new go.TextBlock({ alignment: go.Spot.Center, font: 'bold 12pt sans-serif' })
            .bind('text')
        ));
    ...
    myDiagram.nodeTemplateMap.add('Sider', // an overall table header, on the left side
      new go.Part('Auto', {
        ...
        .add(
          new go.Shape({ fill: 'transparent', strokeWidth: 0 }),
          new go.TextBlock({ alignment: go.Spot.Center, font: 'bold 12pt sans-serif', angle: 270 })
            .bind('text')
        ));
