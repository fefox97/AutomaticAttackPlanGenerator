...
<meta itemprop="description" content="Importing some SVG as GoJS Shapes." />
<meta property="og:description" content="Importing some SVG as GoJS Shapes." />
<meta name="twitter:description" content="Importing some SVG as GoJS Shapes." />
...
<meta itemprop="name" content="Tiger Drawn in SVG using Shapes" />
<meta property="og:title" content="Tiger Drawn in SVG using Shapes" />
<meta name="twitter:title" content="Tiger Drawn in SVG using Shapes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/tiger.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/tiger.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/tiger.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/tiger.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/tiger.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Tiger Drawn in SVG using Shapes | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  const tigersvg = `<?xml version="1.0" encoding="UTF-8"?>
...
<path id="path962" stroke="#000000" d="M361.097,863.271c0,0,2.648-19.422-17.655,3.531"/>
  ...
  function init() {
    ...
    const tigerdrawing = new go.Panel(); // this Panel holds all of the Shapes for the drawing
    const xmldoc = new DOMParser().parseFromString(tigersvg, 'text/xml');
    ...
    const tigerpart = new go.Part(); // doesn't need to be a Node for this sample
...
<div id="sample">
  ...
  <p>
    This sample converts an SVG string into many <a>Shape</a>s inside of a position
    <a>Panel</a>. For each path in the SVG there is a <a>Shape</a> with the
    corresponding <a>Shape.geometry</a>.
  </p>
</div>
