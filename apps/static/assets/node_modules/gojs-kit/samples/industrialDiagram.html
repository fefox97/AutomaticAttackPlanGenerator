...
<script id="code">
  ...
  function init() {
    ...
    myDiagram.nodeTemplate =
      new go.Node('Auto')
        .bind('location', 'location', go.Point.parse)
        .add(
          new go.TextBlock({ margin: 3, font: 'bold 15px sans-serif' })
            .bind('text')
        );

    myDiagram.nodeTemplateMap.add('Tower',
      new go.Node('Position', {})
        ...
        .add(
          ...
          new go.Shape({
            ...
            .bind('fill', 'color', gradientBrush)
            .bind('position', 'height', height => new go.Point(0, height))
        ));
      ...
      new go.Node('Table')
        ...
        .add(
          new go.Shape('Arrow', {
            ...
            .bind('fill', 'color', gradientBrush)
            .bind('column', 'textside', side => side === 'right' ? 0 : 1),
          new go.TextBlock({ margin: 3, font: 'bold 15px sans-serif' })
            .bind('text')
            .bind('column', 'textside', side => side === 'right' ? 1 : 0)
        ));

    myDiagram.nodeTemplateMap.add('Heater',
      new go.Node('Position')
        .bind('location', 'location', go.Point.parse)
        .add(
          new go.Shape({
