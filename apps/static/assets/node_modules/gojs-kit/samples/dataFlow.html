...
<meta itemprop="description" content="Data flow or workflow graph of nodes with varying input and output ports with labels, oriented horizontally." />
<meta property="og:description" content="Data flow or workflow graph of nodes with varying input and output ports with labels, oriented horizontally." />
<meta name="twitter:description" content="Data flow or workflow graph of nodes with varying input and output ports with labels, oriented horizontally." />
...
<meta itemprop="name" content="Data Flow Diagram of SQL Operation Nodes with Multiple Labeled Input and Output Ports" />
<meta property="og:title" content="Data Flow Diagram of SQL Operation Nodes with Multiple Labeled Input and Output Ports" />
<meta name="twitter:title" content="Data Flow Diagram of SQL Operation Nodes with Multiple Labeled Input and Output Ports" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/dataflow.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/dataflow.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/dataflow.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/dataFlow.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/dataFlow.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Data Flow Diagram of SQL Operation Nodes with Multiple Labeled Input and Output Ports | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  function init() {
    ...
    function makeTemplate(typename, icon, background, inports, outports) {
      myDiagram.nodeTemplateMap.set(typename,
        new go.Node('Spot')
          .add(
            new go.Panel('Auto', { width: 100, height: 120 })
              .add(
    ...
    myDiagram.linkTemplate =
      new go.Link({
        ...
        .add(
          new go.Shape({ stroke: 'gray', strokeWidth: 2 }),
          new go.Shape({ stroke: 'gray', fill: 'gray', toArrow: 'Standard' })
        );
...
<div id="sample">
  ...
  <p>
    ...
    <a href="dataFlowVertical.html">Data Flow (vertical)</a> sample.
  </p>
  <div>
    <div>
