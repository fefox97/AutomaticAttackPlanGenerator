...
<meta itemprop="description" content="The DrawCommandHandler extension implements various commands for aligning and rotating objects and for handling arrow keys to select or shift." />
<meta property="og:description" content="The DrawCommandHandler extension implements various commands for aligning and rotating objects and for handling arrow keys to select or shift." />
<meta name="twitter:description" content="The DrawCommandHandler extension implements various commands for aligning and rotating objects and for handling arrow keys to select or shift." />
...
<meta itemprop="name" content="Drawing Commands for Aligning, Spacing, Rotating, Z-Ordering, and Arrow Keys" />
<meta property="og:title" content="Drawing Commands for Aligning, Spacing, Rotating, Z-Ordering, and Arrow Keys" />
<meta name="twitter:title" content="Drawing Commands for Aligning, Spacing, Rotating, Z-Ordering, and Arrow Keys" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/drawcommandhandler.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/drawcommandhandler.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/drawcommandhandler.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/DrawCommandHandler.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/DrawCommandHandler.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Drawing Commands for Aligning, Spacing, Rotating, Z-Ordering, and Arrow Keys | GoJS Diagramming Library
    </title>
  </head>
...
<script id="code">
  ...
  function arrowMode() {
    ...
    } else if (document.getElementById('select').checked === true) {
      myDiagram.commandHandler.arrowKeyBehavior = 'select';
    } else if (document.getElementById('scroll').checked === true) {
      myDiagram.commandHandler.arrowKeyBehavior = 'scroll';
    } else if (document.getElementById('tree').checked === true) {
      myDiagram.commandHandler.arrowKeyBehavior = 'tree';
    } else if (document.getElementById('none').checked === true) {
      myDiagram.commandHandler.arrowKeyBehavior = 'none';
    }
  }
...
<div id="sample">
  ...
  <p>
    ...
    Space Evenly:
    <button onclick="myDiagram.commandHandler.alignRow(30)">Into Row (space 30)</button>
    <button onclick="myDiagram.commandHandler.alignColumn(30)">Into Column (space 30)</button>
    <button onclick="myDiagram.commandHandler.spaceEvenlyHorizontally()">Horizontally</button>
    <button onclick="myDiagram.commandHandler.spaceEvenlyVertically()">Vertically</button>
    </br>
    Rotate:
    ...
    <input type="radio" name="arrow" id="none" onclick="arrowMode()">None</input>
  </p>
  <p>
    ...
    It is defined in its own file, as <a href="../extensions/DrawCommandHandler.js">DrawCommandHandler.js</a>.
  </p>
  <p>
    The above buttons can be used to align Parts, rotate Parts, or change the behavior of the arrow keys.
  </p>
  <p>
    Usage can also be seen in the <a href="../samples/bpmn/BPMN.html">BPMN Editor</a> sample.
  </p>
</div>
