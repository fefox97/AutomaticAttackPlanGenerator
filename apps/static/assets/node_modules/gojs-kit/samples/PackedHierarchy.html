...
<meta itemprop="name" content="Packed Hierarchy Diagram: Nested Circular Groups" />
<meta property="og:title" content="Packed Hierarchy Diagram: Nested Circular Groups" />
<meta name="twitter:title" content="Packed Hierarchy Diagram: Nested Circular Groups" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/packedhierarchy.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/packedhierarchy.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/packedhierarchy.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/PackedHierarchy.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/PackedHierarchy.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Packed Hierarchy Diagram: Nested Circular Groups | GoJS Diagramming Library
    </title>
  </head>
...
<script type="module" id="code">
  ...
  const myDiagram = new go.Diagram('myDiagramDiv', {
    layout: new HierarchyLayout(), // defined above
  ...
  function nodeStyle(node) {
    node.toolTip = toolTipTemplate;
    node.selectionAdornmentTemplate = selectionAdornmentTemplate;
    node.doubleClick = (e, node) => {
    ...
    new go.Node('Auto')
      ...
      .add(
        new go.Shape({
          ...
          .bind('fill'),
        new go.TextBlock({ font: '10px Helvetica, Arial, sans-serif', stroke: 'white', maxLines: 1 })
          .bind('text')
          .bind('font')
          .bind('stroke', 'fill', f => go.Brush.isDark(f) ? 'white' : 'black')
      );

  myDiagram.groupTemplate =
    new go.Group({ layout: new HierarchyLayout() })
      .apply(nodeStyle)
      .add(
        new go.Shape('Circle', { fill: 'rgba(128,128,128,0.33)' })
