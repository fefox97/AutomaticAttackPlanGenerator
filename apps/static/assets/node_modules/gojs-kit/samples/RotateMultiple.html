...
<meta itemprop="description" content="Allow the user to rotate multiple nodes at the same time by using the RotateMultipleTool extension." />
<meta property="og:description" content="Allow the user to rotate multiple nodes at the same time by using the RotateMultipleTool extension." />
<meta name="twitter:description" content="Allow the user to rotate multiple nodes at the same time by using the RotateMultipleTool extension." />
...
<meta itemprop="name" content="Rotate Multiple Nodes Simultaneously in Realtime either Together or Individually" />
<meta property="og:title" content="Rotate Multiple Nodes Simultaneously in Realtime either Together or Individually" />
<meta name="twitter:title" content="Rotate Multiple Nodes Simultaneously in Realtime either Together or Individually" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/rotatemultiple.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/rotatemultiple.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/rotatemultiple.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/RotateMultiple.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/RotateMultiple.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      Rotate Multiple Nodes Simultaneously in Realtime either Together or Individually | GoJS Diagramming Library
    </title>
  </head>
...
<script src="../extensions/RotateMultipleTool.js"></script>
<script id="code">
  function init() {
...
<div id="sample">
  ...
  <p>
    This sample demonstrates a custom <a>RotatingTool</a> which allows the user to rotate many selected objects at once. It is defined in its own file, as
    <a href="../extensions/RotateMultipleTool.js">RotateMultipleTool.js</a>.
  </p>
  <p>Hold down the control key in order to rotate each selected node individually, rather than all of them collectively.</p>
</div>
