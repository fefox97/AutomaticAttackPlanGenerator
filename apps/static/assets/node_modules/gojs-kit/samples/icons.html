...
<meta itemprop="description" content="Use SVG geometry path strings to create vector icons, rather than using images." />
<meta property="og:description" content="Use SVG geometry path strings to create vector icons, rather than using images." />
<meta name="twitter:description" content="Use SVG geometry path strings to create vector icons, rather than using images." />
...
<meta itemprop="name" content="SVG Icons: Using SVG Path Strings as Shapes in Nodes" />
<meta property="og:title" content="SVG Icons: Using SVG Path Strings as Shapes in Nodes" />
<meta name="twitter:title" content="SVG Icons: Using SVG Path Strings as Shapes in Nodes" />


<meta property="og:image" content="https://gojs.net/latest/assets/images/screenshots/svgicons.png" />
<meta itemprop="image" content="https://gojs.net/latest/assets/images/screenshots/svgicons.png" />
<meta name="twitter:image" content="https://gojs.net/latest/assets/images/screenshots/svgicons.png" />

<meta property="og:url" content="https://gojs.net/latest/samples/icons.html" />
<meta property="twitter:url" content="https://gojs.net/latest/samples/icons.html" />
...
<meta property="twitter:domain" content="gojs.net" />
    ...
    <title>
      SVG Icons: Using SVG Path Strings as Shapes in Nodes | GoJS Diagramming Library
    </title>
  </head>
...
<script>
  ...
  var icons = {
    ...
    'arrow down left': 'M19.5 4.5L4.5 19.5M4.5 19.5L15.75 19.5M4.5 19.5L4.5 8.25',
    ...
    'arrow down right': 'M4.5 4.5L19.5 19.5M19.5 19.5V8.25M19.5 19.5H8.25',
    'arrow down tray':
    ...
    'arrow down': 'M19.5 13.5L12 21M12 21L4.5 13.5M12 21L12 3',
    'arrow left circle':
    ...
    'arrow long down': 'M15.75 17.25L12 21M12 21L8.25 17.25M12 21L12 3',
    'arrow long left': 'M6.75 15.75L3 12M3 12L6.75 8.25M3 12H21',
    'arrow long right': 'M17.25 8.25L21 12M21 12L17.25 15.75M21 12H3',
    'arrow long up': 'M8.25 6.75L12 3M12 3L15.75 6.75M12 3V21',
    ...
    'arrow small down': 'M12 4.5V19.5M12 19.5L18.75 12.75M12 19.5L5.25 12.75',
    'arrow small left': 'M19.5 12L4.5 12M4.5 12L11.25 18.75M4.5 12L11.25 5.25',
    'arrow small right': 'M4.5 12L19.5 12M19.5 12L12.75 5.25M19.5 12L12.75 18.75',
    'arrow small up': 'M12 19.5L12 4.5M12 4.5L5.25 11.25M12 4.5L18.75 11.25',
    ...
    'arrow up left': 'M19.5 19.5L4.5 4.5M4.5 4.5L4.5 15.75M4.5 4.5L15.75 4.5',
    ...
    'arrow up right': 'M4.5 19.5L19.5 4.5M19.5 4.5L8.25 4.5M19.5 4.5V15.75',
    'arrow up tray':
    ...
    backspace:
      'M12 9.75L14.25 12M14.25 12L16.5 14.25M14.25 12L16.5 9.75M14.25 12L12 14.25M9.42051 19.1705L3.04551 12.7955C2.60617 12.3562 2.60617 11.6438 3.04551 11.2045L9.42051 4.82951C9.63149 4.61853 9.91764 4.5 10.216 4.5L19.5 4.5C20.7427 4.5 21.75 5.50736 21.75 6.75V17.25C21.75 18.4926 20.7427 19.5 19.5 19.5H10.216C9.91764 19.5 9.63149 19.3815 9.42051 19.1705Z',
    backward:
      'M21 16.8115C21 17.6753 20.0668 18.2169 19.3169 17.7883L12.2094 13.7269C11.4536 13.295 11.4536 12.2052 12.2094 11.7733L19.3169 7.7119C20.0668 7.28334 21 7.82487 21 8.68867V16.8115Z',
    banknotes:
    ...
    'bars 2': 'M3.75 9H20.25M3.75 15.75H20.25',
    'bars 3 bottom left': 'M3.75 6.75H20.25M3.75 12H20.25M3.75 17.25H12',
    'bars 3 bottom right': 'M3.75 6.75H20.25M3.75 12H20.25M12 17.25H20.25',
    'bars 3 center left': 'M3.75 6.75H20.25M3.75 12H12M3.75 17.25H20.25',
    'bars 3': 'M3.75 6.75H20.25M3.75 12H20.25M3.75 17.25H20.25',
    'bars 4': 'M3.75 5.25H20.25M3.75 9.75H20.25M3.75 14.25H20.25M3.75 18.75H20.25',
    'bars arrow down':
    ...
    bell: 'M14.8569 17.0817C16.7514 16.857 18.5783 16.4116 20.3111 15.7719C18.8743 14.177 17.9998 12.0656 17.9998 9.75V9.04919C17.9999 9.03281 18 9.01641 18 9C18 5.68629 15.3137 3 12 3C8.68629 3 6 5.68629 6 9L5.9998 9.75C5.9998 12.0656 5.12527 14.177 3.68848 15.7719C5.4214 16.4116 7.24843 16.857 9.14314 17.0818M14.8569 17.0817C13.92 17.1928 12.9666 17.25 11.9998 17.25C11.0332 17.25 10.0799 17.1929 9.14314 17.0818M14.8569 17.0817C14.9498 17.3711 15 17.6797 15 18C15 19.6569 13.6569 21 12 21C10.3431 21 9 19.6569 9 18C9 17.6797 9.05019 17.3712 9.14314 17.0818',
    'bolt slash':
    ...
    bolt: 'M3.75 13.5L14.25 2.25L12 10.5H20.25L9.75 21.75L12 13.5H3.75Z',
    'book open':
...
<!-- load SVG definitions for many icons in the "icons" variable -->
<script id="code">
...
<div id="sample">
  <div class="flex flex-row flex-wrap">
    <div class="mr-2 w-min flex-none">
      <div
        id="myDiagramDiv"
    ...
    <div class="min-w-[400px] flex-1">
      <p>
        Here is a simple example <a>Diagram.nodeTemplate</a> for the selected <a>Node</a>. The shape
        of the "icon" is made with a <a>Geometry</a> string. To see more examples on how this works
        see the <a href="../intro/geometry.html#ShapeGeometryString">Shape Geometry String</a> intro
        page.
      </p>
      <pre><code id="codeBox" class="lang-js"></code></pre>
    </div>
  </div>

  <p>
    This sample shows several "icons" that were originally SVG paths, used as Shapes in GoJS.
    Alternatively this could be achieved using <a>TextBlock</a>s to display symbols from a custom
    font. The <a href="fonticons.html">Font Icons sample</a>
    is a good example of this.
  </p>
  <p>
    You can easily add your own shapes to GoJS by writing your own geometry strings, or by copying
    SVG path strings, as is done in this sample. The icons for this sample are defined in this page.
  </p>
  <p><a href="../intro/geometry.html">Read more about GoJS path syntax here.</a></p>

  <p>
    The icons in this sample are from a selection of free icons at
    <a href="https://icomoon.io" target="blank">icomoon.io</a>
  </p>
</div>
