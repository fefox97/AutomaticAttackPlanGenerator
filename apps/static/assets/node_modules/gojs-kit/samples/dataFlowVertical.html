...
<script id="code">
  function init() {
    ...
    function makePort(name, leftside) {
      const port = new go.Shape('Circle', {
        fill: '#555555',
        stroke: null,
      ...
      const panel = new go.Panel('Vertical', { margin: new go.Margin(0, 2) });
    ...
    function makeTemplate(typename, icon, background, inports, outports) {
      myDiagram.nodeTemplateMap.set(typename, 
        new go.Node('Spot', { selectionAdorned: false })
          .add(
            new go.Panel('Auto', { width: 200, height: 90 })
              .add(
                new go.Shape('RoundedRectangle', {
                  ...
                  .bindObject('fill', 'isSelected', s => s ? 'dodgerblue' : background),
                new go.Panel('Table')
                  .add(
    ...
    myDiagram.linkTemplate =
      new go.Link({
        ...
        .add(
          new go.Shape({ stroke: '#555555', strokeWidth: 2 })
        );
