...
<script id="code">
  function init() {
    ...
    const graygrad = new go.Brush('Linear', { 0: '#F5F5F5', 1: '#F1F1F1' });
    const bluegrad = new go.Brush('Linear', { 0: '#CDDAF0', 1: '#91ADDD' });
    const yellowgrad = new go.Brush('Linear', { 0: '#FEC901', 1: '#FEA200' });
    const lavgrad = new go.Brush('Linear', { 0: '#EF9EFA', 1: '#A570AD' });

    myDiagram.nodeTemplate =
      new go.Node('Auto', { isShadowed: true })
        .add(
    ...
    myDiagram.linkTemplate =
      new go.Link({ selectable: false, corner: 10 }) // the whole link panel
        .add(
