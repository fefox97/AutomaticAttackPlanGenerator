...
class APIUtils:
    ...
    def generate_pentest_report(self, app_id, app_name, query_output, html_columns=None):
        try:
            ...
            prompt = "Hello, I need a detailed report on this attack plan generated by my app. Provide the text formatted in HTML and be detailed, do not omit any attack. \n\n" + attack_plan_json
